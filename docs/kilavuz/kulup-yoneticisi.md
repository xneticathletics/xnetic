# X-NETIC Kullanma Kılavuzu — Kulüp Yöneticisi

Kulübünün tamamını yöneten kişi olarak kullandığın bölümler.

## İçindekiler

1. [🚀 Başlarken ve Hesap](#başlarken-ve-hesap) (11)
2. [🏠 Ana Sayfa ve Bildirimler](#ana-sayfa-ve-bildirimler) (5)
3. [👤 Profil ve Ayarlar](#profil-ve-ayarlar) (5)
4. [👥 Sporcu Yönetimi ve Kayıt İşlemleri](#sporcu-yönetimi-ve-kayıt-işlemleri) (12)
5. [🧒 Sporcum (Veli ve Sporcu)](#sporcum-veli-ve-sporcu) (1)
6. [📅 Takvim, Antrenman ve Yoklama](#takvim-antrenman-ve-yoklama) (8)
7. [🏆 Müsabakalar](#müsabakalar) (4)
8. [🧑‍🏫 Antrenörler](#antrenörler) (8)
9. [🏛️ Kulüp Yapısı (Branş, Grup, Salon)](#kulüp-yapısı-branş-grup-salon) (4)
10. [⚙️ Kulüp Ayarları](#kulüp-ayarları) (8)
11. [💰 Finans ve Aidat](#finans-ve-aidat) (9)
12. [📊 Performans Ölçümleri](#performans-ölçümleri) (5)
13. [🏋️ Fitness](#fitness) (6)
14. [🥗 Beslenme](#beslenme) (3)
15. [🌡️ Günlük Check-in ve Zorluk Derecesi](#günlük-check-in-ve-zorluk-derecesi) (3)
16. [🎪 Etkinlik, Turnuva ve Kamp](#etkinlik-turnuva-ve-kamp) (3)
17. [🛍️ Mağaza](#mağaza) (2)
18. [📸 Sosyal Alan](#sosyal-alan) (3)
...
### İlk girişteki onay (KVKK) ekranı
...
### "Hesabın İnceleniyor" / abonelik ekranı
...
### Önceki ekrana / Ana Sayfa'ya dönme
...
## 🏠 Ana Sayfa ve Bildirimler

### Kulüp Yöneticisi Ana Sayfası
...
### Bildirimleri görme (zil simgesi)
...
### Ana Sayfa kutucuklarını kapatma/açma
...
### Ana Sayfa'daki duyuru önizlemesi
...
### Kişisel bilgileri ve fotoğrafı güncelleme
...
### Giriş bilgisini (telefon/kullanıcı adı/e-posta) değiştirme
...
## 👥 Sporcu Yönetimi ve Kayıt İşlemleri

### Sporcuları görüntüleme ve arama
...
### Sporcu bilgisini düzenleme, pasife alma, silme
...
### Sporcu detay ekranında neler var
...
### Veli / sporcu giriş hesabı açma ve bağlama
...
### Excel'den toplu sporcu aktarma
...
### Sporcu tipi (Spor Okulu / Müsabık)
...
### Sporcuyu ikinci bir branşa/gruba ekleme
...
## 🧒 Sporcum (Veli ve Sporcu)

### Antrenmanları telefonumun takvimine ekleme
...
## 📅 Takvim, Antrenman ve Yoklama

### Takvimi kullanma (antrenman/müsabaka)
...
### Tek seferlik antrenman oluşturma
...
### Haftalık antrenman planı oluşturma
...
### Antrenmanı silme veya düzenleme
...
### Yoklama pencerelerini ayarlama
...
### Müsabaka (maç) ekleme ve kadro seçme
...
### Antrenörleri görüntüleme ve arama
...
### Antrenör bilgilerini düzenleme / kulüpten çıkarma
...
### Antrenörü gruba atama (baş / yardımcı)
...
### Antrenörün branşı, kademesi ve belge bilgisi
...
## 🏛️ Kulüp Yapısı (Branş, Grup, Salon)

### Kulüp Yapısı nedir (branş, grup, salon)
...
### Kayıt Dondurma'yı kulüpte açma/kapatma
...
### Kulüp adı ve logosunu değiştirme
...
### Antrenör maaş/ödeme planı oluşturma
...
### Antrenör ödemelerini antrenöre göre filtreleme
...
### Finans ekranı nasıl kullanılır
...
### Sporcuya aidat planı oluşturma
...
### Branş bazlı sabit aidat ücreti
...
### Aidatı ödendi olarak işaretleme, uyarı gönderme, dekont/makbuz
...
### Finansal Dökümanlarım / Excel'e aktarma
...
### Sporcunun performans ölçümünü kaydetme
...
### Test grubuyla toplu ölçüm girme
...
### Kulübe özel test ekleme / düzenleme
...
### Bir sporcunun tüm ölçümlerini görüntüleme
...
### Sporcunun egzersiz ağırlığını/tekrarını kaydetme
...
### Kulübe özel egzersiz ekleme / genel hareketleri gizleme
...
### Fitness grup programı oluşturup yayınlama
...
### Sporcuların bireysel fitness programlarını inceleme
...
### Besin, tarif ve rehber yazısı ekleme
...
### Beslenme Rehberi yazılarını okuma
...
## 🌡️ Günlük Check-in ve Zorluk Derecesi

### Sporcuların check-in durumunu izleme
...
### Günlük Check-in'i açma/kapatma ve saatini ayarlama
...
### Zorluk derecesini açma/kapatma ve süresini ayarlama
...
## 🎪 Etkinlik, Turnuva ve Kamp

### Etkinlik, turnuva ve kampları görme
...
### Etkinlik / turnuva / kamp oluşturma ve yayınlama
...
### Etkinlik kayıtlarını onaylama / reddetme
...
### Mağazaya ürün ekleme / düzenleme
...
### Sosyal paylaşımı onaylama / silme
...
### Mesajı okuyup okumadığını anlama / okunmamış mesaj
...
### Duyuruyu kimlerin okuduğunu görme / duyuru silme
...
### Duyuruların ne kadar süre görüneceğini ayarlama
...
### Rozetler nedir, nasıl kazanılır
...
### Rozet eşiklerini değiştirme / Şampiyon rozeti verme
...
### Roller ne yapabilir (Yönetici, Koordinatör, Antrenör, Veli, Sporcu)
...
### Fotoğraf/galeri yüklenmiyor (izin)
...
### Veriler yüklenmiyor / bağlantı sorunu
...
### Yanlışlıkla sildim, geri alabilir miyim
...
### Bir özelliği hangi ekranda bulurum
...
*Bu kılavuz uygulamadaki Asistan ile aynı içeriği kullanır. Sorun yaşarsan: Profil → Yardım / Destek.*
