...
// Bu, plan.created_at'a dayandığı için topUpCoachPlan İSTER ilk oluşturma
// anında ister düzenli tazeleme sırasında (topUpAllActiveCoachPlans)
// çağrılsın her zaman geçerlidir.
...
// Kulüpteki tüm aktif antrenör ödeme planlarını, her ekran açılışında 3
// aylık ufka göre tazeler — zaman ne kadar geçmiş olursa olsun önümüzdeki
// 3 ay otomatik olarak "bekliyor" durumunda hazır bulunur.
