...
export default function HomeStack({ role }: { role: UserRole }) {
  return (
    ...
    >
      ...
      <Stack.Screen name="SocialFeed" component={SocialFeedScreen} options={{ headerShown: false, title: "Sosyal", animation: "fade", animationDuration: 150 }} />
      ...
      <Stack.Screen name="Shop" component={ShopScreen} options={{ headerShown: false, title: "Mağaza", animation: "fade", animationDuration: 150 }} />
      ...
      <Stack.Screen name="ShopManage" component={ShopManageScreen} options={{ headerShown: false, title: "Mağaza", animation: "fade", animationDuration: 150 }} />
      ...
      <Stack.Screen name="EventsList" component={EventsListScreen} options={{ headerShown: false, title: "Etkinlik/Turnuva/Kamp", animation: "fade", animationDuration: 150 }} />
      ...
      <Stack.Screen name="EventsManage" component={EventsManageScreen} options={{ headerShown: false, title: "Etkinlik/Turnuva/Kamp", animation: "fade", animationDuration: 150 }} />
