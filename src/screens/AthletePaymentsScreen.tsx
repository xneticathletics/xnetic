...
const styles = StyleSheet.create({
  ...
  addButton: { borderWidth: 1, borderColor: colors.yellow, borderRadius: radius.sm, paddingHorizontal: spacing.sm, paddingVertical: 10 },
  addButtonText: { color: colors.yellow, fontWeight: "700", fontSize: 12 },
