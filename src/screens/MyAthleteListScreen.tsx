...
// Velinin birden fazla sporcusu varsa "Sporcum" karosuna basınca buraya
// düşer — tek sporcusu varsa HomeScreen zaten doğrudan AthleteDetail'e
// yönlendiriyor (bkz. HomeScreen.tsx handleTilePress "sporcum").
export default function MyAthleteListScreen({ navigation }: Props) {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.subtitle}>Profilini görüntülemek istediğin sporcuyu seç.</Text>
