...
// "Sporcu Tarifleri" karosuyla birebir aynı yer).
export default function NutritionRecipesScreen({ navigation }: Props) {
  return (
    <ScrollView style={styles.container} contentContainerStyle={{ padding: spacing.lg }}>
      <Text style={styles.subtitle}>Bir kategori seç — sporcu içecekleri, barlar ve pratik tarifler seni bekliyor.</Text>
      ...
      <View style={styles.grid}>
        {FOOD_CATEGORIES.map((cat) => (
          <TouchableOpacity
            ...
            activeOpacity={0.85}
            onPress={() => navigation.navigate("NutritionRecipeCategory", { category: cat.key })}
          >
