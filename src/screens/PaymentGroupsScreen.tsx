...
const styles = StyleSheet.create({
  ...
  addButton: { flex: 1, borderWidth: 1, borderColor: colors.yellow, borderRadius: radius.sm, paddingHorizontal: 2, paddingVertical: 8, alignItems: "center", justifyContent: "center" },
  addButtonText: { color: colors.yellow, fontWeight: "700", fontSize: 10, textAlign: "center" },
