-- send_birthday_notifications ayrı ele alındı çünkü metninde emoji (🎉/🎂)
-- var — genel WIN1252 tersine-çevirme dönüşümü emoji baytlarında başarısız
-- oluyor (WIN1252'de karşılığı olmayan bayt kombinasyonları). Mantık/yapı
-- birebir aynı, sadece Türkçe metinler ve emoji doğru UTF-8 ile yeniden
-- yazıldı.
